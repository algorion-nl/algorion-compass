...
export type MacroNewsStartNode = Node<{ name: string, description: string, status: string }, 'macro-news-start-node'>;
export type AppNode = BuiltInNode | AgentNode | InvestmentReportNode | JsonOutputNode | PortfolioStartNode | PortfolioManagerNode | StockAnalyzerNode | MacroNewsStartNode;
